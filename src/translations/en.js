export const TRANSLATIONS_EN = {
    ...
    homeInfoFooterText: "You are kindly invited to contact us. It will be a pleasure to help you to meet your needs", //Olga
    ...
    simultaneaContent: "In standard simultaneous mode, the interpreter sits in a booth with a clear view of the meeting room and the speaker. He or she listens to and simultaneously interprets the speech into a target language. Standard simultaneous interpreting requires a booth (fixed or mobile)  as well as other appropriate equipment (headphones, microphones).",
    ...
    susurradaContent: "The interpreter is seated next to one or two meeting participants and whispers the interpretation of the speech. This mode is used mainly when only very few people need interpretation. This interpreting mode is also commonly known by its classic French name, ",
    susurradaContentI: "chuchotage.",
    interpretacionRemota: "Remote Simultaneous Interpretation -RSI",
    interpretacionRemotaContent: "The interpreter is not in the same location as the conference participants. The interpreter follows the meeting via a screen and console by resorting to  telecommunication media, video or interpretation platforms.",
